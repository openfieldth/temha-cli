...
3. Log in with your Templatehouse account to access your projects.
```bash
# For SNS login users, please reset your password to get a new one before logging in.
$ npm run login
```

4. Check your project ID and pull the project.
```bash
# Pull all projects
$ npm run pull
...
5. Upload Project After Modifications (Export)
```bash
